...
def generic_qb_av_table(seasons, productions, salary_func, option_years=None, void_years=None):
    surplus_val = 0
    breakdown = []
    ...
    for season, prod in zip(seasons, productions):
        ...
        season_breakdown = {'Season': season, 'QBR': prod, 'Market Sal': val_prod, 'Actual Sal': val_act, 'Inflation Adj': inflation_adj,'Tot. Surplus Value': total_surplus_value}
        if has_option:
